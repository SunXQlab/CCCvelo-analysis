...
result_path = "/home/yll/velocity_methods/01_analysis/apply_in_stereo_cortex/TFvelo_result/"
...
adata_rc.obs['Cluster'] = adata_rc.obs['scc_anno']
print(adata_rc.obs['Cluster'])
adata_rc.uns['Cluster_colors'] = ['#d62728', '#2ca02c', '#1f77b4',  '#ff7f0e']  
...
plt.savefig(os.path.join(plt_path, "TFvelo_violin_plot_psd.pdf"), format='pdf')
plt.close()
